import { ToggleAnimeLikeUseCase } from '../../../../../src/application/use-cases/user/toggle-anime-like.use-case.js';
...
describe('ToggleAnimeLikeUseCase', () => {
  let useCase: ToggleAnimeLikeUseCase;
  ...
  beforeEach(() => {
    ...
    useCase = new ToggleAnimeLikeUseCase(userRepository, animeRepository);
  });

  it('deve alternar o status de like do anime com sucesso', async () => {
