...
import { UserOutputDTO, AddAnimeToListInputDTO } from '../../dtos/user.dto.js';
import UserMapper from '../../mappers/user.mapper.js';
import { NotFoundError } from '../../errors/index.js';

export class AddAnimeToListUseCase {
  constructor(
    private readonly userRepository: IUserRepository,
    private readonly animeRepository: IAnimeRepository,
  ) {}

  async execute(input: AddAnimeToListInputDTO): Promise<UserOutputDTO> {
...
export default AddAnimeToListUseCase;
