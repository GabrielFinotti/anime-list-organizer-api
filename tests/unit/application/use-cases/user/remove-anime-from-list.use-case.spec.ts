import { RemoveAnimeFromListUseCase } from '../../../../../src/application/use-cases/user/remove-anime-from-list.use-case.js';
...
describe('RemoveAnimeFromListUseCase', () => {
  let useCase: RemoveAnimeFromListUseCase;
  ...
  beforeEach(() => {
    ...
    useCase = new RemoveAnimeFromListUseCase(userRepository, animeRepository);
  });

  it('deve remover um anime da lista do usuário com sucesso', async () => {
